  ...
  const handleAcceptContract = async (contractId: number) => {
    try {
      ...
      addNotification({
        ...
        message: `You've accepted the contract "${selectedContract?.title}". The deal is now active and you can start working!`,
        action: {
          label: 'View Contract',
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-4">
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span>${contract.amount} ({contract.paymentType})</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-muted p-4 rounded-md space-y-2">
                  <p className="text-sm">
                    <span className="font-medium">Amount:</span> ${selectedContract.amount}
                  </p>
                  <p className="text-sm">
                    <span className="font-medium">Type:</span> {selectedContract.paymentType}
                  </p>
                  <p className="text-sm">
